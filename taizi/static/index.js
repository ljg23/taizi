(function(w) {
    ...
    w.showGameScoreLayer = function() {
        ...
        let score_text = '得分&nbsp;&nbsp;';
        score_text += deviation_time < 99999999999999999999999999999999999999999 ? _gameScore : "<span style='color:red;'>" + _gameScore + "</span>";
        document.getElementById('GameScoreLayer-score').innerHTML = score_text;
        let bast = cookie('bast-score');
        if (deviation_time < 999999999999999999999999) {
